...
var ArchivedNotesComponent = /** @class */ (function () {
    function ArchivedNotesComponent(noteService, archivedNoteService, router) {
        this.noteService = noteService;
        this.archivedNoteService = archivedNoteService;
        this.router = router;
    }
    ArchivedNotesComponent.prototype.ngOnInit = function () {
        this.archiveNote();
    };
    ArchivedNotesComponent.prototype.archiveNote = function () {
        var _this = this;
        this.id = this.archivedNoteService.getId();
        this.noteService.findNoteById(this.id).subscribe(function (data) {
            //get note to archive
            _this.note = data;
            //create archived note
            _this.archivedNote.noteId = data.noteId;
            _this.archivedNote.noteTitle = data.noteTitle;
            _this.archivedNote.noteContent = data.noteContent;
            _this.archivedNote.isArchive = true;
            //save archived note
            _this.archivedNoteService.createArchivedNote(_this.archivedNote);
            //delete note from list.
            _this.noteService.deleteNote(data.noteId);
            _this.router.navigate(['/archivedlist']);
        });
    };
    ArchivedNotesComponent.ctorParameters = function () { return [
...
var ArchivedNoteListComponent = /** @class */ (function () {
    function ArchivedNoteListComponent(archivedNoteService, router) {
        this.archivedNoteService = archivedNoteService;
        this.router = router;
    }
    ArchivedNoteListComponent.prototype.ngOnInit = function () {
        this.getNotes();
    };
    ArchivedNoteListComponent.prototype.getNotes = function () {
        var _this = this;
        this.archivedNoteService.getAll().subscribe(function (data) {
            _this.notes = data;
        });
    };
    ArchivedNoteListComponent.prototype.deleteNote = function (id) {
        var _this = this;
        this.archivedNoteService.deleteArchivedNote(id).subscribe(function (data) {
            console.log(data);
            _this.getNotes();
            alert('Note Deleted');
        });
    };
    ArchivedNoteListComponent.prototype.archiveNote = function (id) {
    };
    ArchivedNoteListComponent.prototype.editNote = function (id) {
        this.router.navigate(['/edit']);
        this.archivedNoteService.saveId(id);
    };
    ArchivedNoteListComponent.ctorParameters = function () { return [
    ...
    return ArchivedNoteListComponent;
}());
...
var CreateNoteComponent = /** @class */ (function () {
    function CreateNoteComponent(noteService, router) {
        this.noteService = noteService;
        this.router = router;
    ...
    CreateNoteComponent.prototype.newNote = function () {
        this.submitted = false;
        this.note = new _model_note_note__WEBPACK_IMPORTED_MODULE_2__["Note"]();
    };
    CreateNoteComponent.prototype.save = function () {
        this.noteService.createNote(this.note).subscribe(function (data) { return console.log(data); }, function (error1) { return console.log(error1); });
        this.note = new _model_note_note__WEBPACK_IMPORTED_MODULE_2__["Note"]();
    };
    CreateNoteComponent.prototype.onSubmit = function () {
        this.submitted = true;
        this.save();
    ...
    CreateNoteComponent.ctorParameters = function () { return [
...
var EditNoteComponent = /** @class */ (function () {
    function EditNoteComponent(noteService, router) {
        this.noteService = noteService;
        this.router = router;
    ...
    EditNoteComponent.prototype.getNoteToEdit = function () {
        var _this = this;
    ...
    EditNoteComponent.prototype.update = function () {
        this.noteService.updateNote(this.note).subscribe(function (data) { return console.log(data); }, function (error1) { return console.log(error1); });
        this.router.navigate(['/notes']);
    };
    ...
    EditNoteComponent.ctorParameters = function () { return [
...
var NoteDetailsComponent = /** @class */ (function () {
    function NoteDetailsComponent(noteService, noteList) {
        this.noteService = noteService;
        this.noteList = noteList;
    }
    NoteDetailsComponent.prototype.ngOnInit = function () {
    };
    NoteDetailsComponent.ctorParameters = function () { return [
        { type: _services_note_note_service__WEBPACK_IMPORTED_MODULE_2__["NoteService"] },
...
var NoteListComponent = /** @class */ (function () {
    function NoteListComponent(noteService, archivedNoteService, router) {
        this.noteService = noteService;
        this.archivedNoteService = archivedNoteService;
        this.router = router;
    }
    ...
    NoteListComponent.prototype.getNotes = function () {
        var _this = this;
        this.noteService.getAll().subscribe(function (data) {
            _this.notes = data;
        });
    };
    NoteListComponent.prototype.deleteNote = function (id) {
        var _this = this;
        this.noteService.deleteNote(id).subscribe(function (data) {
            console.log(data);
            _this.getNotes();
        });
    };
    NoteListComponent.prototype.archiveNote = function (id) {
        var _this = this;
        //get note
        this.noteService.findNoteById(id).subscribe(function (data) {
            _this.note = data;
            //do the exchange
            _this.noteToArchive = new src_app_model_note_archivednote__WEBPACK_IMPORTED_MODULE_5__["ArchivedNote"](_this.note.noteId, _this.note.noteTitle, _this.note.noteContent, true);
            _this.archivedNoteService.createArchivedNote(_this.noteToArchive).subscribe(function (data) { return console.log(data); }, function (error1) { return console.log(error1); });
            //delete from notes
            _this.noteService.deleteNote(_this.note.noteId).subscribe(function (data) { return console.log(data); }, function (error1) { return console.log(error1); });
            _this.getNotes();
        });
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.changeLink1 = function () {
        document.getElementById('notesLink').classList.add('active');
        document.getElementById('addLink').classList.remove('active');
        document.getElementById('archivedLink').classList.remove('active');
    };
    NavComponent.prototype.changeLink2 = function () {
        document.getElementById('addLink').classList.add('active');
        document.getElementById('notesLink').classList.remove('active');
        document.getElementById('archivedLink').classList.remove('active');
    };
    NavComponent.prototype.changeLink3 = function () {
        document.getElementById('addLink').classList.remove('active');
        document.getElementById('notesLink').classList.remove('active');
...
var ArchivedNote = /** @class */ (function () {
    function ArchivedNote(noteId, noteTitle, noteContent, isArchive) {
        this.noteId = noteId;
        this.noteTitle = noteTitle;
        this.noteContent = noteContent;
        this.isArchive = isArchive;
    }
    ArchivedNote.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: String },
        { type: Boolean }
...
var ArchivedNoteService = /** @class */ (function () {
    function ArchivedNoteService(http) {
        this.http = http;
        this.baseURL = '//localhost:8080/api/archivednotes';
    }
    //Create New ArchivedNote
    ArchivedNoteService.prototype.createArchivedNote = function (note) {
        return this.http.post(this.baseURL + '/addArchived', note);
    };
    //Read/Find by ID
    ArchivedNoteService.prototype.findArchivedNoteById = function (id) {
        return this.http.get(this.baseURL + '/findArchived/' + id);
    };
    //Update Existing ArchivedNote
    ArchivedNoteService.prototype.updateArchivedNote = function (note) {
        return this.http.put(this.baseURL + '/updateArchived', note);
    };
    //Delete Existing ArchivedNote
    ArchivedNoteService.prototype.deleteArchivedNote = function (id) {
        return this.http.delete(this.baseURL + '/deleteArchived/' + id);
    };
    //Get all ArchivedNotes
    ArchivedNoteService.prototype.getAll = function () {
        return this.http.get(this.baseURL + '/getAllArchived');
    };
    ArchivedNoteService.prototype.saveId = function (id) {
        this.id = id;
    };
    ArchivedNoteService.prototype.getId = function () {
        return this.id;
    };
    ArchivedNoteService.ctorParameters = function () { return [
...
var NoteService = /** @class */ (function () {
    ...
    //Read/Find by ID
    NoteService.prototype.findNoteById = function (id) {
    ...
    NoteService.prototype.saveId = function (id) {
        this.id = id;
    };
    NoteService.prototype.getId = function () {
        return this.id;
    };
